...
exports.calculateMac = function (options) {
    ...
    var hmac = Crypto.algo.HMAC.create(options.algorithm.toUpperCase(), options.key).update(normalized);
...
exports.calculateHash = function (payload, algorithm) {
    ...
    if(!Crypto.hasOwnProperty(algorithm) || 
        typeof Crypto[algorithm] !== 'function') throw "Unsupported crypto algorithm: " + algorithm;
